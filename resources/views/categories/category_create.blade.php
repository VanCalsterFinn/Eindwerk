...
<div class="flex justify-center items-center flex-col w-full">
    ...
    <form method="POST" action="/category/create" class="w-1/2">
        @csrf 
        <div class="flex justify-center flex-col mt-4 form-group">
            <label for="name">Name *</label>
            <input name="name" type="text" id="name" placeholder="Name of the category (no special characters)" class="@error('name') is-invalid @enderror shadow">
            @error('name')
        ...
        <div class="flex justify-center flex-col mt-4 form-group">
            ...
            <input name="description" type="text" id="description" placeholder="Description of the category" class="@error('description') is-invalid @enderror shadow">
            @error('description')
                <div class="text-red-600">{{ $message }}</div>
            @enderror
        </div>
